...
function showResult(label, aConf, nConf) {
  ...
  rEl.style.color = risk === 'HIGH' ? '#ff8fa0' : risk === 'MODERATE' ? '#e8b84b' : '#69f0ae';
...
function printResult(type) {
  ...
  printEl.innerHTML = `
    <div class="pr-header">
      <div>
        <div class="pr-header-title">🧬 NailScan AI — Diagnostic Report</div>
    ...
    <div class="pr-footer">NailScan AI &nbsp;|&nbsp; SBBU Final Year Project 2024/25 &nbsp;|&nbsp; For Academic &amp; Research Use Only</div>
  `;
